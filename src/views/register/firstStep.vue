                        ...
                        <el-col :span="11">
                            <el-form-item label="管理员账号" style="width:90%;position:relative" prop="enterAccount">
                                <el-input v-model.trim="enteradminForm.enterAccount"
                                          placeholder="30长度以内英文数字的组合，管理员账号设置后不允许修改!" maxlength='30'>
                                </el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :span="11">
                            <el-form-item label="管理员手机" style="width:90%;position:relative" prop="mobile">
                                <el-input v-model.trim="enteradminForm.mobile" maxlength='11'
                                          placeholder="手机号码用于密码找回!"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                            ...
                            <el-form-item label="验证码"
                                ...
                                <el-input v-model.trim="enteradminForm.code" maxlength='6'>
                                    <template slot="append"
                                        ...
                                        <el-button size="small" type="primary" :disabled="canClick" @click="validCode">
                                            {{ btnContent }}
                                        </el-button>
                                    </template>
                                </el-input>
...
<script>
  ...
  export default {
    ...
    data() {
      ...
      return {
        form: { enterName: '', enterTelNum: '', enterMail: '' }, //表单
        rules: {
          enterTelNum: [
        ...
        enteradminForm: {
          enterAccount: '', mobile: '', code: '', password: '', checkPsd: ''
        },
        rules3: {
          enterAccount: [
