          ...
          <el-form-item prop="code"
            ...
            <el-input v-model="mobileForm.code" maxlength="6">
              <template slot="append"
                ...
                <el-button size="small" type="primary" @click="validCode" v-if="!canClick">
                  获取验证码
                </el-button>
                <el-button size="small" type="primary" v-if="canClick&&!isCanClick">
                  {{time}}s后重新发送
                </el-button>
                <el-button size="small" type="primary" @click="validCode" v-if="canClick&&isCanClick">
                  重新发送
                </el-button>
              </template>
            </el-input>
